...
\TODO{Say that Actor-critic has no problem when $\deltat\to 0$? With SGD
but not with RMSProp, and needs robust exploration}
...
\cite{MunosBourgines98} use a grid algorithm to provably solve the HJB
equation when discretization tends to $0$. However,
