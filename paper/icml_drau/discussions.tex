...
position and momentum, the optimal policy may need to turn round a
certain number of times before reaching the desired state. At the
points of state space where the number of turns changes, the value is
discontinuous.
...
for actions taken on the frontier. This occurs,
...
\TODO{+ discuss the use of LSTMs to provide memory/deal with
non-observability; Such LSTMs should take timescales into account, eg
chrono init?}
