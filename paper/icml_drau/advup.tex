...
to an action-dependent quantity which, if it can be learned, contains the necessary information for policy improvement:
...
\end{equation}
with $\Theta = (\theta, \pi)$. To avoid cumbersome notation, in what follows,
...
Still, this reparameterization does not, on its own, guarantee that
