...
\TODO{CT and LB are fighting each other about the importance which should be given to the next paragraph. A impartial judge should give his opinion. (CT is wrong)} However, the proposed reparameterization does not, on its own, guarantee that
