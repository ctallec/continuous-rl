...
\emph{Orhnstein-Ullenbeck}~\cite{orn-ull} process to actions, is naturally time
...
a continuous \emph{Orhnstein-Ullenbeck} process is defined as
\begin{equation}
...
well defined stochastic process as $\deltat \rightarrow 0$.
...
making sure that $\max_a A^\pi(s, a) = 0$, either approximately or exactly for all
states.
\begin{algorithm}[ht]
