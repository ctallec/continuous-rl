...
differential equations, except for
Theorem~\ref{thm:policyimprovement}, which uses a nice argument specific
to reinforcement learning to prove that the continuous-time advantage
function contains all the necessary information for policy values.
