...
\TODO{More on that later. In noisy setups we may need $\frac{1}{\deltat^\frac{3}{2}}$ for the last term of the loss.}
...
\end{equation}
Learning rate on $\phi$ and $b$ are of order $\deltat$, learning rate on $\theta$ is of order $\deltat^2$. This is to have gradients moving of approximately $\sqrt{dt}
