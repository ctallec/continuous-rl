...
Similarily, in non reversible environments, $V$ can vary extremely quickly, and
even be non continuous, with gaps of order of magnitude $\frac{1}{1 - \gamma}$.
A reasonable model to learn such a function is
\begin{align}
	V_\theta(s) = \tilde{V}_\theta(s) + \bern(\rho_\theta(s)dt)
\end{equation}
\end{document}
