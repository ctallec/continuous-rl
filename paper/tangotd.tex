...
$Z(s_1,s_2)\gets...$ via gradient descent on the parameters of $Z$.
...
equation by $Z(s_1,s_3)$ (up to some $\gamma$-dependent factor). I'm not
sure what to do with the resulting $Z(s_1,s_2)$. On-policy, another
...
trajectory, and moving back for $s_1$ and forward for $s_2$.
