...
\end{equation}
however, having
$\transp{\Delta}\rho^2\Delta$ means we are just facing the double sampling
...
If one has access to some features $\Psi$,
the minimizer of a weird norm $L^2(\rho \Psi\transp{\Psi}\rho)$ is better
