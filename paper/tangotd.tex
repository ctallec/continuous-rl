...
Also, when observing a transition $s\to s'$, eligibility traces updates
the info about how to reach $s'$, while TD updates the info about the
reward when starting from $s$. I feel that somehow we have to use both:
