...
\end{equation}
which after applying to $\1_{s_1}$ on the left and $\1_{s_2}/\rho(s_2)$
on the right yields
\begin{multline}
...
$0$ ($Z(s,s)=1/\rho(s)$, although starting with $Z(s,s)=1$ should be
enough). In the end this Newton equation alone might be sufficient to
