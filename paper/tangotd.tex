...
\rho(\Id-P)V=\rho R
\end{equation}
(equivalent if $\rho$ is positive), both sides are samplable, and we can try to solve the above by
stochastic gradient-like methods.

For instance, ff we parameterize $V$ by some parameter $\theta$, we can apply
