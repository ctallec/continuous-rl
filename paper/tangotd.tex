...
\rho(\Delta V-R)
\end{equation}
(variant 2, under the conditions of the footnote).
Setting
\begin{equation}
...
Therefore, if $C$ is definite positive, then variant 1 and variant 2 will converge to
...
\Delta-\Delta)
\end{equation}
Therefore, $C$ is definite positive provided
\begin{equation}
\transp{(\tilde
\Delta-\Delta)}\rho(\tilde
...
to the true environment $\Delta$ (moreover the left-hand-side is at
second order in the error). Therefore, convergence is guaranteed in a relatively large
