...
$A$ antisymmetric. Let $L\deq \rho S^{-1} \rho$. Then we have to prove that
...
Thus we have a two-timescale algorithm for non-linear TD in the off-policy
overparameterized case; it minimizes the Dirichlet norm. TODO WRONG: $S$
IS NOT NECESSARILY POSITIVE!!!!! $S$ is positive if $\rho=\mu$, so,
correct on-policy.
