...
$\E_{s_2\sim \rho} f(s_2)\psi(s_2)$ is equal to $\E_{s_2\sim \rho_\psi}
f(s_2)(\E_{\rho}\abs{\psi})$. This will significantly reduce variance,
especially for test functions $\psi$ that are concentrated aroudn a few
points.
