...
this can be done via TANGO. More on that later.
...
on-policy or assuming overparameterization. (Indeed in the latter case we
are back to the tabular case.) TODO
...
$\Phi$, projected in $L^2(\rho)$. This is GTD with orthonormalization of
$\Phi$, namely,
\begin{equation}
