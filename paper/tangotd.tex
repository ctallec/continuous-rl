...
composition of optimal actions, though.
...
the Newton method for matrix inversion anymore (because the operator
$\Id-\gamma \max_a \E_{\cdot|a}$ is not linear), so convergence
is unclear.
