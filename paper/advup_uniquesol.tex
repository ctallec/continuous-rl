...
experience replay from past transitions. Otherwise, a large learning rate
for $b$ just results in $b$ being equal to the average of recent the
...
same distribution as $s$, but it has to use the same policy... this is
delicate of policy changes.)
